...
// WithID adds the id to the get org params
func (o *GetOrgParams) WithID(id string) *GetOrgParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get org params
func (o *GetOrgParams) SetID(id string) {
	o.ID = id
}
