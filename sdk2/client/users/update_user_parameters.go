...
// WithRequest adds the request to the update user params
func (o *UpdateUserParams) WithRequest(request *models.UpdateUserRequest) *UpdateUserParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the update user params
func (o *UpdateUserParams) SetRequest(request *models.UpdateUserRequest) {
	o.Request = request
}
