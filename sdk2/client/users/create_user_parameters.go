...
// WithRequest adds the request to the create user params
func (o *CreateUserParams) WithRequest(request *models.CreateUserRequest) *CreateUserParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create user params
func (o *CreateUserParams) SetRequest(request *models.CreateUserRequest) {
	o.Request = request
}
